...
export default function Generate() {
    ...
    const handleSubmit = async () => {
        ...
        try{
            const response = await fetch('api/generate', {method: 'POST', body: text,})
            if(!response.ok) {
        ...
        <Container  maxWidth="md">
            ...
            {flashcards.length > 0 && (
                <Box sx={{ mt: 4 }}>
                    ...
                    <Grid container spacing={2}>
                        {flashcards.map((flashcard,index) => (<Grid item xs={12} sm={6} md={4} key={index}>
                            <Card>
                                <CardContent>
            ...
            <Dialog open={dialogOpen} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    ...
                    <TextField autoFocus margin="dense" label="Set Name" type="text" fullWidth value={setName} onChange={(e) => setSetName(e.target.value)}/>
                </DialogContent>
                <DialogActions>
